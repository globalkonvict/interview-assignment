      ...
      <nav className='navbar is-white'>
        <div className='navbar-brand'>
          <a href='#' className='logo'>
            ...
            >
              <linearGradient id='trello-logo-gradient-defaultbig' x1='50.048061%' x2='50.048061%' y1='100%' y2='0%'>
        ...
        <div id='navbarBasicExample' className={`navbar-menu ${navActive ? 'is-active' : ''}`}>
          ...
          <div className='navbar-end'>
            <div className='navbar-item'>
              <a className='login-btn ' href='/login?returnUrl=%2Fb%2FC4Awm5lK%2Fkanban-board'>
                Log in
              </a>
              <a className='get-trello-btn'>Get Trello for free</a>
            </div>
          </div>
        </div>
      </nav>
